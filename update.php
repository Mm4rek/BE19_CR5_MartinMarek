...
if (isset($_POST["update"])) {
    ...
    if ($_FILES["picture"]["error"] == 0) {
        ...
        $sql = "UPDATE users SET first_name = '$fname', last_name = '$lname', picture = '$picture[0]', date_of_birth = '$date_of_birth', email = '$email', phone_number = '$phone_number', address = '$address' WHERE id = {$id}";
    } else {
        $sql = "UPDATE users SET first_name = '$fname', last_name = '$lname', date_of_birth = '$date_of_birth', email = '$email', phone_number = '$phone_number', address = '$address' WHERE id = {$id}";
    }
...
<div class="container">
    ...
    <form method="post" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="phone" name="phone_number" placeholder="Phone number"
