...
if (mysqli_num_rows($resultSeniorAnimals) > 0) {
    while ($rowSeniorAnimal = mysqli_fetch_assoc($resultSeniorAnimals)) {
        ...
        $animalCard .= "      <a href='update.php?id={$rowSeniorAnimal["id"]}' class='btn btn-primary'>Update</a>";
        $animalCard .= "      <a href='delete.php?id={$rowSeniorAnimal["id"]}' class='btn btn-success'>Delete</a>";
        $animalCard .= "    </div>";
        $animalCard .= "  </div>";
        $animalCard .= "</div>";
